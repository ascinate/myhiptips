                                ...
                                <div class="col-9">
                                    <div class="top-next-h row">
                                        <div class="col-8">
                                            <div class="let-herd">
                                                <h1 id="dept">
                                                    {{ request()->post('department') != "" ? request()->post('department') : 'Employees' }}
                                                </h1>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="right-pays">
                                                <h1>
                                                    ...
                                                    <span id="amt">
                                                        @if(request()->post('tip') == 'other')
                                                            ${{ request()->post('custom_tip') }}
                                                        @else
                                                            ${{ request()->post('tip') }}
                                                        @endif
                                                    </span>
                                    ...
                                    <div class="user-ndame-d d-flex align-items-start">
                                        ...
                                        <h5> 
                                            <span id="dl">{{ request()->post('lname') }}</span>
                                            <span class="d-block" id="rl"> Room No: {{ request()->post('room') }} </span>
                                        </h5>
                                    </div>
                                </div>
                            </div>
